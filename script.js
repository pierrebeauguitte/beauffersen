const englishText = {
    'title': 'Astrid & Pierre\'s wedding!',
    'main-text': `<h2>We are getting married ...</h2>
...
<p>Châteauroux:</p>
<ul>
<li><a href="https://all.accor.com/hotel/1080/index.fr.shtml" target="_blank">Ibis Châteauroux</a></li>
<li><a href="https://www.elyseehotelchateauroux.com/" target="_blank">Elysée Hotel</li>
<li><a href="https://www.chateauroux-tourisme.com/preparer-mon-sejour/ou-dormir/" target="blank">More options</a> (available in somewhat understandable, auto-translated English)</li>
</ul>

<p>Issoudun:</p>
<ul>
<li><a href="https://www.les3rois.fr/" target="_blank">Les trois rois</a></li>
<li><a href="https://hotel-de-la-gare-la-locomotive-issoudun.hotelmix.fr/" target="_blank">La locomotive</a></li>
<li><a href="http://www.la-cognette.com/" target="_blank">La Cognette</a></li>
<li><a href="https://issoudun.kyriad.com/" target="_blank">Kyriad Issoudun</a></li>
<li><a href="https://www.tourisme.issoudun.fr/o-dormir" target="_blank">More options (French only)</a>. At the bottom of the page there are two lists of smaller B&Bs and summer houses in the area.</li>
</ul>

<h3>Camping at the Sarzay castle</h3>

<p>It’s possible to camp at the site, using the chateau’s facilities. Please let us know if you want to do this as we need to let the owners know. We will stay at the site ourselves (but inside!) so we would be delighted if you were staying there!</p>

<h3>Camping at La Châtre</h3>
...
const frenchText = {
    'title': 'Mariage d\'Astrid & Pierre !',
    'main-text': `<h2>On se marie ...</h2>
...
<li><a href="https://all.accor.com/hotel/1080/index.fr.shtml" target="_blank">Ibis Châteauroux</a></li>
<li><a href="https://www.elyseehotelchateauroux.com/" target="_blank">Elysée Hotel</li>
<li><a href="https://www.chateauroux-tourisme.com/preparer-mon-sejour/ou-dormir/" target="blank">Autres options</a></li>
</ul>
...
<li><a href="http://www.la-cognette.com/" target="_blank">La Cognette</a></li>
<li><a href="https://issoudun.kyriad.com/" target="_blank">Kyriad Issoudun</a></li>
<li><a href="https://www.tourisme.issoudun.fr/o-dormir" target="_blank">Plus d'options</a>. Voir en bas de la page pour deux listes de gîtes et chambres d'hôtes dans les environs.</li>
</ul>

<h3>Camping au château de Sarzay</h3>

<p>Il est possible de poser sa tente sur le site du château. Si c'est ce que vous souhaitez, merci de nous en informer pour qu'on puisse avertir les propriétaires. Nous logerons sur le site du château (mais en intérieur !), donc nous serons ravis si vous voulez rester sur place également.</p>

<h3>Camping à La Châtre</h3>
...
const norwegianText = {
    'title': 'Astrid & Pierres Bryllup!',
    'main-text': `<h2>Vi gifter oss ...</h2>
...
<li><a href="https://all.accor.com/hotel/1080/index.fr.shtml" target="_blank">Ibis Châteauroux</a></li>
<li><a href="https://www.elyseehotelchateauroux.com/" target="_blank">Elysée Hotel</li>
<li><a href="https://www.chateauroux-tourisme.com/preparer-mon-sejour/ou-dormir/" target="blank">Flere her</a> (Siden er tilgjengelig på direkteoversatt, men relativt forståelig engelsk)</li>
</ul>
...
<li><a href="http://www.la-cognette.com/" target="_blank">La Cognette</a></li>
<li><a href="https://issoudun.kyriad.com/" target="_blank">Kyriad Issoudun</a></li>
<li><a href="https://www.tourisme.issoudun.fr/o-dormir" target="_blank">Flere her (bare tilgjengelig på fransk)</a>. Nederst på siden er det to lister med vertshus og sommerhus/hytter i området.</li>
</ul>

<h3>Camping på château de Sarzay</h3>

<p>Det er mulig å campe på området og å bruke slottets fasiliteter. Si fra hvis du ønsker å gjøre det så vi kan si fra til eierne. Vi skal selv overnatte på stedet (men inne!) så vi hadde blitt veldig glad hvis dere også overnattet der!</p>
...
function setValues(dict) {
    ...
    document.getElementById('main-text').innerHTML = dict['main-text'];
    document.getElementById('transport-label').innerHTML = dict['transport-label'];
